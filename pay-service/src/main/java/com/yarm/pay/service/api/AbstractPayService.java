...
import com.yarm.pay.common.util.BeanUtil;
import com.yarm.pay.common.util.SignUtils;
import com.yarm.pay.pojo.api.ApiRequest;
...
import com.yarm.pay.service.platform.PayMerchantChannelService;
import com.yarm.pay.service.platform.PayMerchantService;
...
public abstract class AbstractPayService {
     ...
     * @return
     */
    protected ApiResponse validate(PayMerchantBO merchant, ApiRequest request, Class<? extends ApiResponse> clazz) {
        if (merchant == null || merchant.getStatus() != PayMerchantBO.STATUS_ACTIVE) {
