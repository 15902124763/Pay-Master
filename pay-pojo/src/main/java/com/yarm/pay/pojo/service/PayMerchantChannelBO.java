package com.yarm.pay.pojo.service;
 ...
 * Date:2019/6/10
 * Time:20:21
 * Des: 商户允许使用的 支付方式，以及对应的 支付账号。
 *  每个商户基础配置6个， 微信扫码，微信wap，微信app支付，  支付宝扫码，支付宝wap，支付宝app支付。
 */
public class PayMerchantChannelBO {
    private int id;
    ...
    private PayChannelBO payChannel;
    private PayMerchantBO payMerchant;
    ...
    public PayChannelBO getPayChannel() {
        return payChannel;
    }

    public void setPayChannel(PayChannelBO payChannel) {
        this.payChannel = payChannel;
    }

    public PayMerchantBO getPayMerchant() {
        return payMerchant;
    }

    public void setPayMerchant(PayMerchantBO payMerchant) {
